...
@Mod(energymonitor.MODID)
public class energymonitor {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "energymonitor";
    ...
    public energymonitor(FMLJavaModLoadingContext context) {
        ...
        MinecraftForge.EVENT_BUS.register(net.gabsdev.energymonitor.scheduler.EnergyLogScheduler.class);
